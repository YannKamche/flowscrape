...
export namespace Prisma {
  ...
  */
  ...
  > = {
    where?: WorkflowWhereInput;
    orderBy?:
      | WorkflowOrderByWithAggregationInput
      | WorkflowOrderByWithAggregationInput[];
  ...
  type GetWorkflowGroupByPayload<T extends WorkflowGroupByArgs> =
  ...
  type WorkflowGetPayload<
    S extends boolean | null | undefined | WorkflowDefaultArgs,
  ...
  > {
    ...
    >(
      args: SubsetIntersection<T, WorkflowGroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
      ? GetWorkflowGroupByPayload<T>
  ...
  > = {
    ...
    data: XOR<
      ...
      WorkflowUncheckedUpdateManyInput
    >;
    /**
  ...
  export type WorkflowScalarWhereWithAggregatesInput = {
    AND?:
      | WorkflowScalarWhereWithAggregatesInput
      | WorkflowScalarWhereWithAggregatesInput[];
    ...
    description?:
      | StringNullableWithAggregatesFilter<"Workflow">
      | string
      | null;
